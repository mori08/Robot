...
bool Robot::GenerateEvent::load(const Info & info)
{
...
void Robot::GenerateEvent::perform() const
{
	EventManager::Instance().generateObject(_name, generateObjMap[_type](_pos));
}


bool Robot::GenerateEvent::isCompleted() const
{
	return true;
}
